...
public class SimpleRNNNN extends RecurrentNN {
    public SimpleRNNNN() {
        this.NN_type += "SimpleRNN";
        this.getStyleClass().add("SimpleRNN");
    }

    public SimpleRNNNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "SimpleRNN" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public SimpleRNNNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
    ...
    private final int _return_sequences = 17;  // boolean
    private final int _return_state = 18;  // boolean
    private final int _go_backwards = 19;  // boolean (false)
    private final int _stateful = 20;  // boolean (false)
    private final int _unroll = 21;  // boolean (false)
