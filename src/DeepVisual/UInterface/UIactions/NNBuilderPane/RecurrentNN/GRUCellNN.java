...
public class GRUCellNN extends RecurrentNN {
    public GRUCellNN() {
        this.NN_type += "GRUCell";
        this.getStyleClass().add("GRUCell");
    }

    public GRUCellNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "GRUCell" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public GRUCellNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
    ...
    private final int _recurrent_activation = 4;  // Activations
    ...
    private final int _implementation = 17;  // 1 or 2
