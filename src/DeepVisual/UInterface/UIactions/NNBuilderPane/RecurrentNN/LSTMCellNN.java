...
public class LSTMCellNN extends RecurrentNN {
    public LSTMCellNN() {
        this.NN_type += "LSTMCell";
        this.getStyleClass().add("LSTMCell");
    }

    public LSTMCellNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "LSTMCell" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public LSTMCellNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
