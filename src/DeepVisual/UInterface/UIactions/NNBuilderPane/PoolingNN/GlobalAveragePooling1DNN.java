...
public class GlobalAveragePooling1DNN extends PoolingNN {
    public GlobalAveragePooling1DNN() {
        this.NN_type += "GlobalAveragePooling1D";
        this.getStyleClass().add("GlobalAveragePooling1D");
    }

    public GlobalAveragePooling1DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "GlobalAveragePooling1D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public GlobalAveragePooling1DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
