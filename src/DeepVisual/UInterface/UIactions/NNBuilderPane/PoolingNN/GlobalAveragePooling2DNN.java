...
public class GlobalAveragePooling2DNN extends PoolingNN {
    public GlobalAveragePooling2DNN() {
        this.NN_type += "GlobalAveragePooling2D";
        this.getStyleClass().add("GlobalAveragePooling2D");
    }

    public GlobalAveragePooling2DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "GlobalAveragePooling2D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public GlobalAveragePooling2DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
