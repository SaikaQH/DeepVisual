...
public class MaxPooling1DNN extends PoolingNN {
    public MaxPooling1DNN() {
        this.NN_type += "MaxPooling1D";
        this.getStyleClass().add("MaxPooling1D");
    }

    public MaxPooling1DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "MaxPooling1D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public MaxPooling1DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
