...
public class MaxPooling2DNN extends PoolingNN {
    public MaxPooling2DNN() {
        this.NN_type += "MaxPooling2D";
        this.getStyleClass().add("MaxPooling2D");
    }

    public MaxPooling2DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "MaxPooling2D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public MaxPooling2DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
