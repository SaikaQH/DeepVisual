...
public class AveragePooling3DNN extends PoolingNN {
    public AveragePooling3DNN() {
        this.NN_type += "AveragePooling3D";
        this.getStyleClass().add("AveragePooling3D");
    }

    public AveragePooling3DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "AveragePooling3D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public AveragePooling3DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
