...
public class ZeroPadding3DNN extends ConvolutionalNN {
    public ZeroPadding3DNN() {
        this.NN_type += "ZeroPadding3D";
        this.getStyleClass().add("ZeroPadding3D");
    }

    public ZeroPadding3DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "ZeroPadding3D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public ZeroPadding3DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
