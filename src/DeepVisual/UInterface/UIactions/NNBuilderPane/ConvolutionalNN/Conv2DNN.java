...
public class Conv2DNN extends ConvolutionalNN {
    public Conv2DNN() {
        this.NN_type += "Conv2D";
        this.getStyleClass().add("Conv2D");
    }

    public Conv2DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "Conv2D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public Conv2DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
