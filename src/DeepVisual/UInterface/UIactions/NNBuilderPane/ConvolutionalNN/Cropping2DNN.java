...
public class Cropping2DNN extends ConvolutionalNN {
    public Cropping2DNN() {
        this.NN_type += "Cropping2D";
        this.getStyleClass().add("Cropping2D");
    }

    public Cropping2DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "Cropping2D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public Cropping2DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
