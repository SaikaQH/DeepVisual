...
public class UpSampling1DNN extends ConvolutionalNN {
    public UpSampling1DNN() {
        this.NN_type += "UpSampling1D";
        this.getStyleClass().add("UpSampling1D");
    }

    public UpSampling1DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "UpSampling1D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public UpSampling1DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
