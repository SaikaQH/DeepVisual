...
public class Conv2DTransposeNN extends ConvolutionalNN {
    public Conv2DTransposeNN() {
        this.NN_type += "Conv2DTranspose";
        this.getStyleClass().add("Conv2DTranspose");
    }

    public Conv2DTransposeNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "Conv2DTranspose" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public Conv2DTransposeNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
