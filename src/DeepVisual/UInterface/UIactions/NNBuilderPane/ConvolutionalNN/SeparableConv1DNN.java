...
public class SeparableConv1DNN extends ConvolutionalNN {
    public SeparableConv1DNN() {
        this.NN_type += "SeparableConv1D";
        this.getStyleClass().add("SeparableConv1D");
    }

    public SeparableConv1DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "SeparableConv1D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public SeparableConv1DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
