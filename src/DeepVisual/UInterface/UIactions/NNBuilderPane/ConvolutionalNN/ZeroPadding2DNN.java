...
public class ZeroPadding2DNN extends ConvolutionalNN {
    public ZeroPadding2DNN() {
        this.NN_type += "ZeroPadding2D";
        this.getStyleClass().add("ZeroPadding2D");
    }

    public ZeroPadding2DNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "ZeroPadding2D" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public ZeroPadding2DNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
