...
public class GaussianDropoutNN extends NoiseNN {
    public GaussianDropoutNN() {
        this.NN_type += "GaussianDropout";
        this.getStyleClass().add("GaussianDropout");
    }

    public GaussianDropoutNN(double layout_pos_x, double layout_pos_y, int btn_id) {
        this();
        this.NN_id = btn_id;
        this.NN_name = "GaussianDropout" + "_" + NN_id;
        this.setText(this.NN_name);
        initNNBtnPosition(layout_pos_x, layout_pos_y);
        initNNAttribute();
    }

    public GaussianDropoutNN(double layout_pos_x, double layout_pos_y, int btn_id, DeepVisualWindowController _parent) {
