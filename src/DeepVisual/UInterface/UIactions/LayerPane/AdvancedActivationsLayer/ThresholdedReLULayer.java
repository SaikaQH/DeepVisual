...
public class ThresholdedReLULayer extends AdvancedActivationsLayerButton {
    public ThresholdedReLULayer() {
        this.setText("ThresholdedReLU");
        addDragDropEvent();

        layer_type += ".ThresholdedReLU";
        this.getStyleClass().add("ThresholdedReLU");
        this.getStyleClass().add("ChildLayer");
    }

    public ThresholdedReLULayer(DeepVisualWindowController _parent) {
        this();
