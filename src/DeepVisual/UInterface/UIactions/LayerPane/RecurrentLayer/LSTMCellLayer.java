...
public class LSTMCellLayer extends RecurrentLayerButton {
    public LSTMCellLayer() {
        this.setText("LSTMCell");
        addDragDropEvent();
    ...
    public LSTMCellLayer(DeepVisualWindowController _parent) {
        this();
