...
public class CuDNNGRULayer extends RecurrentLayerButton {
    public CuDNNGRULayer() {
        this.setText("CuDNNGRU");
        addDragDropEvent();
    ...
    public CuDNNGRULayer(DeepVisualWindowController _parent) {
        this();
