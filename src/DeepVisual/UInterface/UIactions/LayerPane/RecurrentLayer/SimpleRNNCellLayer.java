...
public class SimpleRNNCellLayer extends RecurrentLayerButton {
    public SimpleRNNCellLayer() {
        this.setText("SimpleRNNCell");
        addDragDropEvent();

        layer_type += ".SimpleRNNCell";
        this.getStyleClass().add("SimpleRNNCell");
        this.getStyleClass().add("ChildLayer");
    }

    public SimpleRNNCellLayer(DeepVisualWindowController _parent) {
        this();
