...
public class SimpleRNNLayer extends RecurrentLayerButton {
    public SimpleRNNLayer() {
        this.setText("SimpleRNN");
        addDragDropEvent();
    ...
    public SimpleRNNLayer(DeepVisualWindowController _parent) {
        this();
