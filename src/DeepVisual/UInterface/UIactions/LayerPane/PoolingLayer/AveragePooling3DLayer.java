...
public class AveragePooling3DLayer extends PoolingLayerButton {
    public AveragePooling3DLayer() {
        this.setText("AveragePooling3D");
        addDragDropEvent();

        layer_type += ".AveragePooling3D";
        this.getStyleClass().add("AveragePooling3D");
        this.getStyleClass().add("ChildLayer");
    }

    public AveragePooling3DLayer(DeepVisualWindowController _parent) {
        this();
