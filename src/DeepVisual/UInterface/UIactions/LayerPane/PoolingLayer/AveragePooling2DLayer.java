...
public class AveragePooling2DLayer extends PoolingLayerButton {
    public AveragePooling2DLayer() {
        this.setText("AveragePooling2D");
        addDragDropEvent();
    ...
    public AveragePooling2DLayer(DeepVisualWindowController _parent) {
        this();
