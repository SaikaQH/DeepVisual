...
public class MaxPooling1DLayer extends PoolingLayerButton {
    public MaxPooling1DLayer() {
        this.setText("MaxPooling1D");
        addDragDropEvent();
    ...
    public MaxPooling1DLayer(DeepVisualWindowController _parent) {
        this();
