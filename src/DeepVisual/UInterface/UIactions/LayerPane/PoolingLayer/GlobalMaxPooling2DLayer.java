...
public class GlobalMaxPooling2DLayer extends PoolingLayerButton {
    public GlobalMaxPooling2DLayer() {
        this.setText("GlobalMaxPooling2D");
        addDragDropEvent();
    ...
    public GlobalMaxPooling2DLayer(DeepVisualWindowController _parent) {
        this();
