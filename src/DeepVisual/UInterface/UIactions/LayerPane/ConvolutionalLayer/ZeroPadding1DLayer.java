...
public class ZeroPadding1DLayer extends ConvolutionalLayerButton {
    public ZeroPadding1DLayer() {
        this.setText("ZeroPadding1D");
        addDragDropEvent();

        layer_type += ".ZeroPadding1D";
        this.getStyleClass().add("ZeroPadding1D");
        this.getStyleClass().add("ChildLayer");
    }

    public ZeroPadding1DLayer(DeepVisualWindowController _parent) {
        this();
