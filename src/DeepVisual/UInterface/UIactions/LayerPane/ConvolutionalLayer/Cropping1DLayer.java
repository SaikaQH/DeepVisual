...
public class Cropping1DLayer extends ConvolutionalLayerButton {
    public Cropping1DLayer() {
        this.setText("Cropping1D");
        addDragDropEvent();

        layer_type += ".Cropping1D";
        this.getStyleClass().add("Cropping1D");
        this.getStyleClass().add("ChildLayer");
    }

    public Cropping1DLayer(DeepVisualWindowController _parent) {
        this();
